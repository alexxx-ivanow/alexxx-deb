...
?><?$APPLICATION->IncludeComponent("bitrix:catalog", "catalog", Array(
	"ACTION_VARIABLE" => "action",	// Название переменной, в которой передается действие
		...
		"LIST_PRODUCT_ROW_VARIANTS" => "[{'VARIANT':'1','BIG_DATA':false}]",	// Вариант отображения товаров
		...
		"MESS_BTN_SUBSCRIBE" => "Заказать",	// Текст кнопки "Уведомить о поступлении"
		...
		"TOP_ELEMENT_COUNT" => "2",	// Количество выводимых элементов
		...
		"TOP_PRODUCT_ROW_VARIANTS" => "[{'VARIANT':'1','BIG_DATA':false}]",	// Вариант отображения товаров
